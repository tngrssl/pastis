...
p.jobs["data-rejecting"]["auto_method_list"] = [reco.data_rejection_method.AUTO_AMPLITUDE,
                                                reco.data_rejection_method.AUTO_LINEWIDTH,
                                                reco.data_rejection_method.AUTO_FREQUENCY,
                                                reco.data_rejection_method.AUTO_PHASE]

p_conc = reco.pipeline()
p_conc.job_list = [ p_conc.jobs["phasing"],
                    p_conc.jobs["scaling"],
                    # p_conc.jobs["FID modulus"],
                    p_conc.jobs["channel-combining"],
                    p_conc.jobs["concatenate"],
                    p_conc.jobs["noise-estimation"],
                    p_conc.jobs["zero-filling"],
                    # p_conc.jobs["physio-analysis"],
                    ...
                    p_conc.jobs["cropping"],
                    p_conc.jobs["displaying"]]

p_conc.jobs["data-rejecting"]["auto_method_list"] = [   reco.data_rejection_method.AUTO_AMPLITUDE,
                                                        reco.data_rejection_method.AUTO_LINEWIDTH,
                                                        reco.data_rejection_method.AUTO_FREQUENCY,
                                                        reco.data_rejection_method.AUTO_PHASE]
...
p_conc.data_physio_filepaths = []

p_conc.display_legends = """
STEAM #1
STEAM #1
STEAM #1
STEAM #1
